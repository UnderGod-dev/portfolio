    ...
    <div className="max-w-sm md:max-w-4xl mx-auto antialiased font-sans px-4 md:px-8 lg:px-12 py-20">
      <div className="relative grid grid-cols-1 md:grid-cols-2  gap-10 md:gap-20">
            ...
            <AnimatePresence>
              {testimonials.map((testimonial, index) => (
                <motion.div
                  ...
                  className="absolute inset-0 origin-bottom overflow-x-hidden"
                >
                  <Image
                    src={testimonial.src}
        ...
        <div className="flex flex-col-reverse justify-between md:flex-col pt-2  md:py-4 items-center md:items-start">
          ...
          >
            <h3 className="text-2xl font-bold dark:text-white/80 text-black">
              {testimonials[active].name}
            </h3>
            <p className="text-sm text-gray-500 dark:text-neutral-500">
              {testimonials[active].designation}
            </p>
            <motion.p className="text-lg text-gray-500 mt-4 md:mt-8 dark:text-neutral-300 h-[168px]">
